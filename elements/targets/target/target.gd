...
const APPLE_POSITION = Vector2(0, 178)
...
func get_free_random_rotation(occupied_rotations: Array, generation_attempts = 0): #get_free_random_ratation возможно подправить придется
